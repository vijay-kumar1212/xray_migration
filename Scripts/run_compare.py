...
class RunCompare(TestRailClient):
    ...
    def cases_not_covered_in_xray(self):
        testrail_cases_desktop, mobile, other = self.get_test_case_titles(236360)
        xr_cases = self.get_tests_from_xray_run('DFE-71660')
        xr_mobile_cases = self.get_tests_from_xray_run('DFE-71661')
