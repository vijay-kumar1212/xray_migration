import pandas as pd
source_file = r"C:\xray_migration\xray_migration\ob digital optimized regression manual.xlsx"
generated_file_from_run = r'C:\xray_migration\xray_migration\Jira.xlsx'
...
pdg_ids = pdg.iloc[:, 2].astype(str).str.replace(r'^C', '', regex=True)
